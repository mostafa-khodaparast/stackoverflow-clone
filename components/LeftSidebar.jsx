        ...
        <div>
            ...
            <SignedOut>
                <div className='my-3 flex flex-col space-y-2'>
                    <Link href='/sign-in' className='mx-auto flex w-[80%] justify-center rounded-lg bg-light-800  px-4 py-3 text-center font-semibold text-dark-400 hover:bg-green-500  dark:bg-dark-400 dark:text-light-900 hover:dark:bg-green-500'>
                        <Image
                    ...
                    <Link href='/sign-up' className='mx-auto flex w-[80%] justify-center rounded-lg bg-light-800 px-4 py-3 text-center font-semibold text-dark-400 hover:bg-green-500 dark:bg-dark-400 dark:text-light-900 hover:dark:bg-green-500'>
                        <Image
